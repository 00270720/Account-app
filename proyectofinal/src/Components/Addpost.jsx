    ...
    return(
        <form id="FormPost"onSubmit={onSubmit} className="space-y-4 text-center w-screen pr-80 pl-80 font-bold  ">
            ...
            <div className="flex flex-col ">
                ...
                <input className="my-1 mx-32 pl-3 rounded bg-gray-300 border-gray-800 border-2" type="text" name="description" id="description"/>
            </div>
            <div className="flex flex-col ">
                <label htmlFor="image">Imagen</label>
                <input className="my-1 mx-32 pl-3 rounded bg-gray-300 border-gray-800 border-2" type="text" name="image" id="image"/>
            </div>
